...
id: F-009
laag: 4
observatie: Concurrenten in zoeksteekproef Kampen/Drenthe: gemeente, Visit, Campercontact, Park4Night; Camperstaan listing/hub niet zichtbaar op plaats/regio-query.
bewijs: zoeksteekproef 13 sep 2026 (feiten.md)
bewijs_label: gemeten
gevolg_zaak: Plek- en regiopagina's concurreren met bronnen en etablissementen.
actie: Zie F-003, F-006; markttabel in rapport-klant.
eigenaar: gedeeld
effort: M
prio: P1
meetpunt: steekproef herhalen na F-003/F-006
afhankelijk_van: [F-003, F-006]
```

```text
id: F-010
laag: 8
observatie: ANWB en KampeerHub genoemd in marktcontext (vergelijkingsdossier); geen eigen steekproef sep 13.
bewijs: vergelijkingsdossier Webregie/Sitewerk
bewijs_label: afgeleid
gevolg_zaak: Thema- en merkspelers naast community-gidsen.
actie: Geen cijfers; markttabel; thema's pas na NL-telling fix (F-001).
eigenaar: stop
effort: S
prio: P3
meetpunt: geen zonder baseline
