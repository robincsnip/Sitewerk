...
6. **Print verplicht:** `npm run audit:finish -- <run-id>` — maakt `print/rapport.html` + `print/rapport.pdf` uit `rapport-klant.md`. Run faalt als PDF ontbreekt. Geen audit zonder print.
